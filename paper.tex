...
\keywords{Type Evolution, Schema Evolution, Live Programming, Local-first Programming, Version Control, Hot Reloading}
...
\textcolor{red}{JE: This structure is offputting. We should write a proper abstract. }

% Context: What is the broad context of the work? What is the importance of the general research area?

\noindent\textbf{Context:} Many recent improvements to programming have come from shortening feedback loops, for example in Live Programming and Distributed Version Control systems.
To continue progress in this direction we need to extend Live Programming across the entire development stack, and to extend collaboration beyond compile time.

% Inquiry: What problem or question does the paper address? How has this problem or question been addressed?
\noindent\textbf{Inquiry:} A key obstacle to live and collaborative programming systems is the problem of \emph{schema evolution}.
When a programmer changes the structure of a datatype, a programming system needs to co-evolve
existing live data and adapt code that implements the program behaviour to match the new structure.
This problem has been studied in isolation as schema evolution in databases, but also recurs in hot code reloading in live programming and dynamic software updating.
We connect these independent efforts in an interdisciplinary inquiry into the problem of schema change through all the layers of the development stack and across all the time-scales of programming.
%Such schema evolutions must occur immediately during live programming, but also neeed to be conveyed through long-term unplanned collaborations.

% Approach: What was done that unveiled new knowledge?
\noindent\textbf{Approach:} We distilled a set of case studies from personal experience, the research literature, and common industry practices. These cases reveal schema change problems recurring in different contexts in the developer stack and at different time-scales of collaboration, not just in database production upgrades.

% Knowledge: What new facts were uncovered? What new capabilities are enabled by the work?
\noindent\textbf{Knowledge:} The problem of schema change is deeper, more widespread, and more interdisciplinary than commonly appreciated. It is a key obstacle to shortening feedback loops in diverse contexts of software development.

% Grounding: What argument, feasibility proof, artifacts, or results and evaluation support this work?
\noindent\textbf{Grounding:} Our work takes the form of a suite of challenge problems drawn from real-world programming
scenarios in diverse field such as live programming, database programming and model-driven
development.
%

% Importance: Why does this work matter?
\noindent\textbf{Importance:} Schema change is a key problem for universal live programming and frictionless collaborative development. Our suite of challenge problems serve to ground further research and provide a basis for evaluation and comparison of results.
...
\begin{itemize}
\item \emph{Schema} -- structure program data and determine aspects of code. A change in schema
...
\item \emph{Data} -- information stored by the program. Data may be more permanent (data in a
  database) or less permanent (state in live programming). When scheam evolve, data needs to be
...
\item \emph{Code} -- or program logic, but not including source code that defines schema.
  When schema evolve, code needs to change to consume/produce data of the correct shape.
\end{itemize}
...
These dimensions, layers, and variants offer a wide range of configurations for challenge problems, but
our aim is not to enumerate all of them. We use them to recast a number of
...
(Fig.~\ref{fig:conf-add}) with a schema and data edit (Fig.~\ref{fig:conf-tab}); the second involves
merging a schema and data edit (Fig.~\ref{fig:conf-tab}) with edit adding code (Fig.~\ref{fig:conf-budget}).
...
The challenge of maintaining multiple divergent schema in programming systems can
...
\challenge{Multiplicity Change in Schema}
...
for Extract Entity. The initial data and schema $D_1, T_1$ co-evolve into $D_2, T_2$ (adding
...
generated for the schema evolution (from $T_1$ to $T_2$) cannot be generated fully automatically.
