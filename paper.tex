...
\newcommand{\openframeworkbox}{
\begin{tcolorbox}[breakable,left=3pt,right=3pt,top=3pt,bottom=3pt,colback=gray!15,colframe=gray!15,parbox=false,
  width=\dimexpr\textwidth\relax,enlarge left by=0mm,boxsep=5pt,arc=0pt,enlarge top by=0.5em,%enlarge bottom by=0.0em,
  outer arc=0pt]\setlength{\parskip}{0.5em}
}
\newcommand{\closeframeworkbox}{
\end{tcolorbox}
}
...
In this example, \textsf{type} refers to data tables, but the same scenario applies to
