...
Our primary contribution is a suite of challenge problems that exemplify a diverse range of typical schema change scenarios which interrupt feedback loops. We believe these problems have not been completely solved in theory or practice (see \S\ref{sec:related}  Related Work). While some of these problems come from our individual research efforts we have attempted to make neutral problem statements not slanted to our preferred approaches. We propose these challenge problems to motivate and facilitate further research. We hope they serve as examples to ground such research and as a basis for evaluating results. We invite contributions of further challenge problems and look forward to discussing competing solutions.
...
Although schema evolution is well-studied in databases (\S\ref{sec:related} Related Work), past work
...
accounting department. We start with data $D_1$ of type~$T_1$. The accounting department
