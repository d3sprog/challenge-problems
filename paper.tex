...
% \definecolor{progblue}{RGB}{64,104,224}
% \renewenvironment{leftbar}[1][\hsize]
% {%
%     \def\FrameCommand
%     {%
%         {\color{progblue}\vrule width 3pt}%
...
definition, but also the necessary live state defined by the definition.
...
we can synthesize new live machine state $+D_1$ conforming to new live machine type $+T_1$.
