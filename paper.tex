...
~
\textcolor{red}{[JE] We could expand our context to include conventional DB systems not just live/local. It is a widespread problem, attested by the many tools to assiste with it. We could include in our problems a description of a typical solution with a standard DB as a sort of baseline. }
