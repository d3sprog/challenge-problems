...
our aim is not to cover all of them. Instead we use them to recast a number of
...
This challenge envisions a new feedback channel that end users have not experienced before: the ability to frictionlessly exchange variations and elaborations they make to docuuments, replacing the hellscape of manual copy \& paste. But meeting this challenge may require a basic change of perspective in both live programming and local-first software.
