...
and code has also been studied \cite{Cleve2006,wang2019synthesizing}.
...
\cite{metamodels,alanen2003difference} and in more low-level work on dynamic software updating
...
BX community:
https://www.cs.cornell.edu/~jnfoster/papers/grace-report.pdf
(overview paper)

Isil Dilig's stuff;
https://www.cs.utexas.edu/~isil/pldi19b.pdf
https://www.cs.utexas.edu/~isil/vldb20.pdf

Eelco Visser/Sander Vermolen
https://dblp.org/pid/10/6098.html
(we’ve discussed the catalog before)

On the code-database co-evolution problem:
https://link.springer.com/chapter/10.1007/11877028_17
(little less technical than Isil’s stuff)

Coupled transformations:
https://dl.acm.org/doi/10.1007/978-3-540-69611-7_19
https://www.sciencedirect.com/science/article/pii/S1571066108003058
https://link.springer.com/chapter/10.1007/978-3-540-87875-9_45

(from the MDD angle, only the tip of the ice berg…)

Divergence in model-driven:
https://dl.acm.org/doi/10.1145/2000410.2000414

The seminal model-diffing paper:
http://btn1x4.inf.uni-bayreuth.de/publications/dotor_buchmann/SCM/ChefRepo/DiffUndMerge/Alanen2003.pdf
(Diffing, versioning, collaborative editing, it’s all well researched in MDD)
