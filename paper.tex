...
In this case study, the evolving \emph{type} is the \texttt{State} type. When the type
...
In this example, \emph{type} refers to data tables, but the same scenario applies to
