...
\begin{figure}[H]
  ...
  \begin{tikzcd}[column sep = large, row sep = 5em]
    ...
    &
    \textsf{schema}_\beta
    \arrow[ld, "\mathit{rebase}\left(\textsf{change}_\alpha {\,,\;} \textsf{change}_\beta\right)"{name=L4, near start, description}]
    \arrow[rr]
    &
    &
    \textsf{data}_\beta
...
\begin{figure}[H]
  ...
  \begin{tikzcd}[column sep = large, row sep = 5em]
    ...
    \arrow[dd, "\mathit{rebase}\left(\textsf{update}_\beta {\,,\;} \textsf{update}_\gamma\right)"{near start, description}]
    \\
    &
    \textsf{schema}
