...
\textrcolor{red}{explicitly speculative section?}
...
Reviewer A
-----------------------------------------------------------------
I will start from the end. In the conclusion you state: 'we developed a conceptual framework....' I disagree. You informally spoke about those ideas in interesting and tough provoking ways, but this is very far from developing a conceptual framework, and if I had to interpret your work as a conceptual framework I would find it severely lacking. However, I do not need to do so, I think your work can stand on its own as a set of considerations of those problems from a unifying viewpoint. This viewpoint is interesting, but is clearly limited and is basically only applicable to layered systems. With imperative systems I mean system with a set of predefined datatypes that are in some sense 'superior' to the user defined ones, that are just lists/records/unions of those primitive data types. This is not the case for example in lambda calculus, where there are no primitive data types, or in pure OO, where everything truly is an object and you could define string and ints as user defined types using programming patterns not dissimilar to church encoding.

Basically, as soon as 'true abstraction' is into place, most of your considerations stop being applicable.
